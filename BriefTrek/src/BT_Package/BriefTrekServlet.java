...
public class BriefTrekServlet extends HttpServlet {
	 ...
	 */
	 /*Principle doGet that takes care all the interaction between the front-end, server-side error detection, 
		Directions class object and dynamic programming graph*/
	 
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//Holds entries from the html form in java variables
		...
		//Extracts all dynamically generated html form inputs
	    ...
	    //Error Detection Class that test whether the products are found in said store
	    DetectProducts dp = new DetectProducts(products, storeId);
		
		//Checks to see if error flag was raised
	    if(dp.getErrorBoolean()) {
			...
			//If no error was raised, then products are safe to be thrown into 
			//Graph class object to find optimal path
		    System.out.println(products);
			Graph tsp = new Graph(products.size());
			
			//If error  occurs in graph then exceptions are generated
			try {
			...
			//Directions are generated by a series of void function calls, could be consolidated and refined
			...
			//Directions are displayed in a HTML page format
